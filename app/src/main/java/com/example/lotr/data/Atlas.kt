...
object Atlas {
    ...
    val places: List<MapPlace> = listOf(
        MapPlace("grey_havens", "The Grey Havens", 0.175f, 0.272f,
        ...
        MapPlace("weathertop", "Weathertop", 0.345f, 0.262f,
        ...
        MapPlace("amon_hen", "Amon Hen", 0.607f, 0.6f,
